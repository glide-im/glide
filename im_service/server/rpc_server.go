...
type IMRpcService struct {
	gateway gate.Server
	sub     subscription_impl.SubscribeWrap
}

func RunRpcService(options *rpc.ServerOptions, gate gate.Server, subscribe subscription.Subscribe) error {
	server := rpc.NewBaseServer(options)
	rpcServer := IMRpcService{
		gateway: gate,
...
func (r *IMRpcService) UpdateClient(ctx context.Context, request *proto.UpdateClient, response *proto.Response) error {
...
func (r *IMRpcService) EnqueueMessage(ctx context.Context, request *proto.EnqueueMessageRequest, response *proto.Response) error {
...
func (r *IMRpcService) Subscribe(ctx context.Context, request *proto.SubscribeRequest, response *proto.Response) error {
...
func (r *IMRpcService) UnSubscribe(ctx context.Context, request *proto.UnsubscribeRequest, response *proto.Response) error {
...
func (r *IMRpcService) UpdateSubscriber(ctx context.Context, request *proto.UpdateSubscriberRequest, response *proto.Response) error {
...
func (r *IMRpcService) RemoveChannel(ctx context.Context, request *proto.RemoveChannelRequest, response *proto.Response) error {
	chanId := subscription.ChanID(request.ChannelID)
...
func (r *IMRpcService) CreateChannel(ctx context.Context, request *proto.CreateChannelRequest, response *proto.Response) error {
	chanId := subscription.ChanID(request.ChannelID)
...
func (r *IMRpcService) UpdateChannel(ctx context.Context, request *proto.UpdateChannelRequest, response *proto.Response) error {
	chanId := subscription.ChanID(request.ChannelID)
	cInfo := request.GetChannelInfo()
	info := subscription.ChanInfo{
		ID:      chanId,
...
func (r *IMRpcService) Publish(ctx context.Context, request *proto.PublishRequest, response *proto.Response) error {
	chanId := subscription.ChanID(request.ChannelID)
